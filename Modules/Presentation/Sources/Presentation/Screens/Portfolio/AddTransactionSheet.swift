            ...
            LazyVGrid(columns: tileColumns, spacing: 10) {
                ForEach(options.operators) { item in
                    SelectableTile(
                        ...
                        color: Color(red: 0.44, green: 0.70, blue: 1.00),
        ...
        Button {
            ...
            .background(
                RoundedRectangle(cornerRadius: 16, style: .continuous)
                    .fill(isFormValid ? Color(red: 0.37, green: 0.86, blue: 0.74) : Color.white.opacity(0.12))
            )
        }
...
private struct FormCardBackground: View {
    var body: some View {
        RoundedRectangle(cornerRadius: 16, style: .continuous)
